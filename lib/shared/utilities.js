/*
* @Last modified in Sublime on Feb 04, 2017 02:43:58 PM
*/
...
const RSA = {
	encryptWithPublicKey(string, key) {
		return crypto.publicEncrypt(key, new Buffer(string)).toString('base64');
	},
	decryptWithPrivateKey(string, key) {
		return crypto.privateDecrypt(key, new Buffer(string, 'base64'));
	}
};
