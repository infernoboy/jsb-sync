/*
* @Last modified in Sublime on Feb 23, 2017 11:52:06 AM
*/
...
const Register = {
	...
	async login(email, password, req) {
		...
		return {
			clientID: client.id,
			syncPasswordSalt: client.syncPasswordSalt,
			syncSessionID: await createSyncSession(client, req)
		};
	},
